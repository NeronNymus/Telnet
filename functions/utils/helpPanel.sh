...
helpPanel(){
	...
	echo -e "\t [2] ${turquoiseColour}./Telnet.sh${endColour}${orangeColour} -i ${endColour}${greenColour}victims${endColour}${orangeColour} -t ${endColour}10${orangeColour} --ssid${endColour}"
