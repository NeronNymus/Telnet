...
def main():
    ...
    if args.ip and args.port:
        ...
        if args.login:
            ...
            handle_target(args.ip, args.port, commands_seq9, 1, True) # Log executed commands
    ...
    # Option -iL is provided
        ...
        for ip in ip_addresses:
            ...
            if args.login:
                ...
                target_handler = threading.Thread(target=handle_target, args=(ip, args.port, commands_seq8, 2, True))
                try:
