...
target = b'10.239.48.158'
commands_seq2 = [
    ENTER,
    b'ping -i 1 -s 65507 -t 64 ' + target + b'\r\n'
]

command_single = b'ping -i 1 -s 65507 -t 64 ' + target + b'\r\n'
...
def handle_target(ip, port, command_sequence, timeout=2, detail=True):
    ...
    log_output =  "/home/grimaldi/Bash/Telnet/pynet/logs/" + ip + "_log"
    ...
    global command_single
    response = socket_send_command(remote_socket, command_single, True)
